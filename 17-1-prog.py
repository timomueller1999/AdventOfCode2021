...
## The computation for max_start_y_velo is probably wrong. But incrementing max_start_y_velo by a very large number (400, in this case) just made the program produce the correct result. Therefore I did not reconsider the logic.
## The summands +50 or -50 for the other values are also "just in case" summands. They are probably not needed.
